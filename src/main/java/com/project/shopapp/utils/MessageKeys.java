...
public class MessageKeys {
    ...
    public static final String DELETE_ORDER_SUCCESSFULLY = "category.delete_order.delete_successfully";
    public static final String DELETE_ORDER_DETAIL_SUCCESSFULLY = "category.delete_order_detail.delete_successfully";
